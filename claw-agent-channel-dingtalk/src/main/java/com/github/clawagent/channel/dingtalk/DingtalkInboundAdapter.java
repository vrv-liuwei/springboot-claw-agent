...
public final class DingtalkInboundAdapter {
    ...
    public static ChannelInboundMessage adapt(ChannelDefinition channel, String channelId, Map<String, Object> payload) {
        ...
        String messageType = firstNonBlank(stringValue(safePayload.get("msgtype")), stringValue(safePayload.get("messageType")), "text");
        ...
        return new ChannelInboundMessage(
                channelId,
                firstNonBlank(stringValue(safePayload.get("conversationId")), stringValue(safePayload.get("openConversationId")), "default"),
                firstNonBlank(stringValue(safePayload.get("senderStaffId")), stringValue(safePayload.get("senderId")), "external"),
                messageType,
                text,
                metadata,
                safePayload);
    ...
    public static boolean detect(Map<String, Object> payload) {
        ...
        // 钉钉机器人回调通常带 conversationId、senderId/senderStaffId 和 msgtype 对应的内容节点。
        return hasKnownMessageNode(payload)
